...
env_name="$1"
remote_path="$2"
description="${3:-DailyDash configuration}"
...
tmp_file="$tmp_dir/value.variable.json"
...
"$ROOT/scripts/wmill.sh" variable push "$tmp_file" "$remote_path"
echo "Variable uploaded: $remote_path"
