...
Evaluate semantic importance only from the supplied market question, description, category, outcomes and resolution horizon. Activity, volume, liquidity, prices, probability changes and trade counts are deliberately withheld. Never infer popularity or crowding from wording alone.

Return seven judgments for every candidate:
