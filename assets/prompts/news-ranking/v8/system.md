...
DailyDash combines these model-provided judgments with a transparent,
deterministic Top-News policy. In particular, a very high `rank_score` cannot
fully compensate for simultaneously low market breadth and low market impact.
Keep every field internally consistent rather than trying to game the downstream
calculation.
